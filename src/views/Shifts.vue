<template>
  <div class="container user-select-none">
    ...
    <p class="text-center">Create a <a :href="createNewShiftURL" target="_blank">new shift via thalia.nu</a> or <a :href="shiftsAdminURL" target="_blank">check out all shift details</a></p>
